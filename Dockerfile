...
ENV __doozer=update BUILD_RELEASE=202410241604.p0.g6aefbbe.assembly.test.el9 BUILD_VERSION=v4.18.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410241604.p0.g6aefbbe.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=cloud-event-proxy __doozer_uuid_tag=ose-cloud-event-proxy-rhel9-v4.18.0-20241024.160420 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=6aefbbe OS_GIT_VERSION=4.18.0-202410241604.p0.g6aefbbe.assembly.test.el9-6aefbbe SOURCE_DATE_EPOCH=1729625102 SOURCE_GIT_COMMIT=6aefbbef95316c07d1fb9149416d628c3c251343 SOURCE_GIT_TAG=6aefbbe SOURCE_GIT_URL=https://github.com/redhat-cne/cloud-event-proxy 
ENV GO111MODULE=off
ENV CGO_ENABLED=1
...
FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:openshift-enterprise-base-rhel9-v4.18.0-20241024.160420 AS bin
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410241604.p0.g6aefbbe.assembly.test.el9" \
